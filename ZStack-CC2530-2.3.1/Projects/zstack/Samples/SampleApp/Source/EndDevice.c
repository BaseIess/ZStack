...
void SampleApp_HandleKeys( uint8 shift, uint8 keys )
{
  if ( keys & HAL_KEY_SW_1 )
  {
    ...
    {
      HalLcdWriteString("Up: Sent", HAL_LCD_LINE_1);
          
    }
    else
    {
      HalLcdWriteString("Up: Not Sent", HAL_LCD_LINE_1);
    }
  }
  ...
  if ( keys & HAL_KEY_SW_2 )
  {
    ...
    if (AF_DataRequest( &SampleApp_Broadcast, &SampleApp_epDesc,
                       ...
                       AF_DEFAULT_RADIUS ) == afStatus_SUCCESS )
    {
      HalLcdWriteString("Right: Sent", HAL_LCD_LINE_1);
    }
    else
    {
      HalLcdWriteString("Right: Not Sent", HAL_LCD_LINE_1);
    }
  }
