...
uint8 errorUartWrite;
unsigned char * stringToSend = ",temperature:25,";
unsigned char * stringToSend2 = ",PH:5,";
unsigned char * stringToSend3 = ",node_okay:1\n";
uint8 * recvBuffer;
uint8 sendBufferSize;
...
void SampleApp_HandleKeys( uint8 shift, uint8 keys )
{
  ...
  if ( keys & HAL_KEY_SW_1 )
  {
    ...
    uint8 sendBufferSize = strlen((char*)stringToSend);      
    errorUartWrite = HalUARTWrite(SAMPLE_APP_PORT,stringToSend,sendBufferSize);
  ...
  if ( keys & HAL_KEY_SW_2 )
  {
    ...
    // HalLedBlink( uint8 leds, uint8 cnt, uint8 duty, uint16 time );
      ...
      uint8 sendBufferSize = strlen((char*)stringToSend2);      
      errorUartWrite = HalUARTWrite(SAMPLE_APP_PORT,stringToSend2,sendBufferSize);
  ...
  if ( keys & HAL_KEY_SW_3 )
  {
    ...
    uint8 sendBufferSize = strlen((char*)stringToSend3);      
    errorUartWrite = HalUARTWrite(SAMPLE_APP_PORT,stringToSend3,sendBufferSize);
